...
Fig1B <- ggplot(merged_data[tissue != "leukemia"], aes(x = UMAP_1, y = UMAP_2)) + 
...
Fig1B
ggsave(outdir("Fig1B_enlarged.png"),Fig1B,dpi=500, w=13, h = 6, units = "cm")
...
# #combine----------------
# first_row <- (Fig1B | plot_spacer() | Fig1F) +
