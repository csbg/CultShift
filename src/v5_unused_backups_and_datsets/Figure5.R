...
correlation_deg_flagged <- correlation_deg_flagged %>%
  filter(!(celltype %in% c("Mono", "MEP.early", "MkP","Gran.","Eo.Ba")))
...
ggsave(basedir("Fig5A.pdf"), w = 18, h = 4.5, units = "cm")
...
ggsave(basedir("Fig5B_scatter_labeled_new.pdf"), width = 13, height = 3.2, units = "cm")
ggsave(basedir("Fig5B_scatter_labeled_no_legend_new.pdf"), width = 15, height = 3.5, units = "cm")
############Fig5C-------
