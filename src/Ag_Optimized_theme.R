optimized_theme <- function() {
  theme_bw() +  # Start with a clean, white background theme
    theme(
      ...
      axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, size = 14, color = "black"),  # Angled X-axis labels for better readability
      ...
      strip.text = element_text(size = 16, face = "bold"),              # Larger, bold facet strip text
