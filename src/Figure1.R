...
Fig1D
ggsave(outdir("Fig1D.png"), plot = Fig1D,dpi = 600,width = 1217, height = 5.5, units = "cm")
...
Fig1E_with_guides <- create_gene_plots_NTC(combined_data, "example_NTC", remove_guides = FALSE)
# Create the plot without guides
Fig1E_without_guides <- create_gene_plots_NTC(combined_data, "example_NTC", remove_guides = TRUE)
...
ggsave(outdir("third_row.pdf"),third_row, w = 11, h = 5.5, units = "cm")
