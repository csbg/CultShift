...
# Directories
# ============================================================
InDir_pred   <- dirout("Ag_ScRNA_23_PerturbNet")
...
out      <- dirout("Ag_ScRNA_25_prediction_Perturb_correlations")
...
write_rds(combined, out("LogFC_invivo_pred_perturb.rds"))
...
write_rds(cor_pred, out("Prediction-actual_cor_perturb.rds"))
...
write_rds(cor_all, out("correlation_to_invivo_exvivo_vs_pred_perturb.rds"))
...
ggsave(out("correlation_pred_vs_exvivo_perturb.pdf"), width = 18, height = 5, units = "cm")
