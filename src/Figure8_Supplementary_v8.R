...
InDir3 <- dirout("Figure2_Supplementary_v8")
basedir <- dirout("Figure8_Supplementary_v8")
...
supp_fig1_genes <- read_rds(InDir3("supp.Fig.2A_genes.rds"))
...
ggsave(basedir("Supplementary_Fig.8.pdf"), w=18, h= 18, units = "cm")
