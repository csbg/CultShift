...
# 
# for(dsx in unique(grep("Mye",unique(SANN[tissue %in% c("in.vivo","ex.vivo","leukemia"),]$sample_found),
#                        value = T))) {
#   
#   # File
...
# only for myeloide differentiation
sample_names <- grep("Mye",unique(SANN[tissue %in% c("in.vivo","ex.vivo","leukemia"),]$sample_found),
                     value = T)
