...
Fig3Ca_heatmap <- ggplot(correlation_results,
  ...
  labs(title = str_wrap("Culture effects anticipate the discrepancies between ex vivo and in vivo perturbation effects ((abs(logFC) of culture effect to abs(logFC) of KO-culture model interaction effect)", 
                        width = 100),
       x = "KO",
       y = "Cell type") +
...
Fig3Ca_heatmap
ggsave(basedir("Fig3Ca_heatmap.pdf"),plot=Fig3Ca_heatmap,
       w=10,h=4, units = "cm")
