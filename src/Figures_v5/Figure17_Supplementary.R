...
basedir <- dirout("Figure17_Supplementary/")
...
ggsave(basedir("Sup.Fig.17A_dot.pdf"),plot = Sup.Fig.17A, w = 18, h = 10,units = "cm")
###############################
#Sup.Fig. 17.B---------------
...
ggsave(basedir("Fig.17C.correlation_examples.pdf"), w = 7, h = 5, units = "cm")
