...
Indir5 <- dirout("Ag_ScRNA_18_zscore_plots_celltype_marker_Mye/")
Indir6 <- dirout("Ag_ScRNA_19_invivo_exvivo_izzo_zscore_Mye/")
out <- "Figure1_Supplementary_Mye"
outdir <- dirout("Figure1_Supplementary_Mye")
